...
restaurants = Restaurant.create([
  ...
  { id: 1,  name: 'El Celler de Can Roca', description: 'Modern Spanish cuisine.', head_chef: 'Joan Roca', city: 'Girona',airport_code: 'GRO', country_display: 'Spain', country_code: 'ESP', price: 150 , website: 'www.cellercanroca.com', lat: 41.993144 , lng: 2.80793 },
  { id: 2,  name: 'Noma', description: "Mould-breaking Nordic food that takes nature’s bounty to new levels", head_chef: 'René Redzepi', city: 'Copenhagen',airport_code: 'CPH', country_display: 'Denmark', country_code: 'DNK', price: 210, website: 'http://noma.dk/', lat: 55.677933, lng: 12.596201 },
  { id: 3,  name: 'Osteria Francescana', description: "Modern Italian cuisine ", head_chef: 'Massimo Bottura', city: 'Modena',airport_code: 'BLQ', country_display: 'Italy', country_code: '', price: , website: 'http://www.osteriafrancescana.it', lat: 44.644802 , lng: 10.921574 },
