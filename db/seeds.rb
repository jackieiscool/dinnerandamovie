...
restaurants = Restaurant.create([
  ...
  { name: 'Osteria Francescana', description: "Modern Italian cuisine ", head_chef: 'Massimo Bottura', city: 'Modena',airport_code: 'BLQ', country_display: 'Italy', country_code: 'IT', price: 200, website: 'http://www.osteriafrancescana.it', lat: 44.644802 , lng: 10.921574 },
